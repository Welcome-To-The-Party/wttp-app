      ...
      <ImageBackground source={background_img} style={styles.background_img}>
          ...
          <View style={styles.dataContainer}>
            <View style={styles.headerCont}>
              <Image source={{uri: user.picture}} style={styles.icon} />
            ...
            <View style={styles.statCont}>
              <View style={styles.statDat}>
                <Text style={styles.statNum}>{user.joinedEvents.length}</Text>
              ...
              <View style={styles.statDat}>
                <Text style={styles.statNum}>{user.grades.length}</Text>
